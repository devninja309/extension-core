    ...
    chrome.scripting.executeScript({
      ...
      function: async () => {
        ...
        els.map((item) => {
          console.log(item)
          if (item.french !== null)
            document.querySelector(item.unique).innerHTML = item.french
        })
      ...
      function: async () => {
        ...
        els.map((item) => {
          ...
          if (item.spanish !== null)
            document.querySelector(item.unique).innerHTML = item.spanish
        })
      ...
      function: async () => {
        ...
        els.map((item) => {
          ...
          if (item.english !== null)
            document.querySelector(item.unique).innerHTML = item.english
        })
        // document.querySelector(result.json().selector)
      },
    })
